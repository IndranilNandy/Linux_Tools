...
# NOTE:
# } >> >(ts '[%Y-%m-%d %H:%M:%S]' >>/home/indranilnandy/MyTools/Linux_Tools/Setup_stages/Automated_post_setup/crontab/cronlogs/system_update.log) - NOT working for root/user, though ts is available and working
# } >> >(ts >>/home/indranilnandy/MyTools/Linux_Tools/Setup_stages/Automated_post_setup/crontab/cronlogs/system_update.log) - NOT working for root/user, though ts is available and working
# } >> /home/indranilnandy/MyTools/Linux_Tools/Setup_stages/Automated_post_setup/crontab/cronlogs/system_update.log - WORKING for root/user
